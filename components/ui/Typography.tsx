...
export function Display({ children, className = "", as: Component = "h1" }: { children: React.ReactNode, className?: string, as?: any }) {
...
export function Hero({ children, className = "", as: Component = "h1" }: { children: React.ReactNode, className?: string, as?: any }) {
...
export function Body({ children, className = "", as: Component = "p" }: { children: React.ReactNode, className?: string, as?: any }) {
  return <Component className={`font-body text-alkota-obsidian ${className}`}>{children}</Component>;
}

export function Label({ children, className = "", as: Component = "span" }: { children: React.ReactNode, className?: string, as?: any }) {
  return <Component className={`font-mono text-xs uppercase tracking-widest text-alkota-stone ${className}`}>{children}</Component>;
}

export function Caption({ children, className = "", as: Component = "p" }: { children: React.ReactNode, className?: string, as?: any }) {
